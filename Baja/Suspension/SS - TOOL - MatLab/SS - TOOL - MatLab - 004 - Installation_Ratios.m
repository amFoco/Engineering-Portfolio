%% Installation Ratios
% - Determines spring and anti-roll bar charactersitics for desired 
% ride/roll rates
% - Installation ratio is a geometric concepts that relates the change in 
% length (or angle) of a force-producing device (spring, shock, 
% anti-rollbar) to a change in vertical wheel center movement

% See "Race Car Vehicle Dynamics" Chapter 16.3, page 595, " Installation
